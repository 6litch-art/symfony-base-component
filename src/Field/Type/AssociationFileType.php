...
class AssociationFileType extends AbstractType implements DataMapperInterface
{
    ...
    public function mapFormsToData(\Traversable $forms, &$viewData): void
    {
        ...
        if ($parentForm?->getData() instanceof PersistentCollection &&
            $this->classMetadataManipulator->isCollectionOwner($parentForm, $parentForm?->getData()) === false) return;
                ...
                foreach($form->getData() ?? [] as $file) {
                    ...
                    if($entity !== null) {
                        ...
                        if($options["entity_data"] ?? false) {
                            ...
                            if(is_callable($options["entity_data"])) $entity = $options["entity_data"]($entity, $parentEntity, $file) ?? $entity;
