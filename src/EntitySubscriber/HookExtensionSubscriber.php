...
use Base\Entity\Extension\Abstract\AbstractMetadata;
...
class ExtensionSubscriber
{
    ...
    public function loadClassMetadata(LoadClassMetadataEventArgs $eventArgs)
    {
        ...
        if ($classMetadata->name != AbstractMetadata::class) {
            return;
        }

        $namingStrategy = $this->entityManager->getConfiguration()->getNamingStrategy();

        $name = $namingStrategy->classToTableName(AbstractMetadata::class) . '_unique';
    ...
    public function postPersist(EventArgs $args)
    {
        ...
        if ($newEntity && $this->entityManager->getCache()) { // @WARN: Attempt to evict AbstractMetadata..doesn't seems to be working.. TBD
