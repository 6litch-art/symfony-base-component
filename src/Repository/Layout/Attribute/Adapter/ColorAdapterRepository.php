 ...
 * @method ColorAdapter|null findOneBy(array $criteria, ?array $orderBy = null)
 * @method ColorAdapter[]    findAll()
 * @method ColorAdapter[]    findBy(array $criteria, ?array $orderBy = null, $limit = null, $offset = null)
 */

class ColorAdapterRepository extends AbstractAdapterRepository
{
}
