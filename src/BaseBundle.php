...
class BaseBundle extends Bundle
{
    ...
    public function __construct() {
        if(!$this->hasInstance()) self::$_instance = $this;
    }

    public const VERSION   = '1.0.0';
    public const USE_CACHE = true;

    public function getProjectDir()  { return $this->container->getParameter('kernel.project_dir'); }
    public function getPublicDir()   { return $this->container->getParameter('kernel.project_dir')."/public/"; }
    public function getSourceDir()   { return $this->container->getParameter('kernel.project_dir')."/src/"; }
    public function getCacheDir()    { return $this->container->getParameter('kernel.cache_dir'); }
    public function getEnvironment() { return $this->container->getParameter('kernel.environment'); }

    protected bool $boot = false;
    public function hasBooted() { return $this->boot; }

    protected bool $bootDoctrine = false;
    public function hasDoctrine():bool { return $this->bootDoctrine; }
    ...
    public function isBroken() { return $this->brokenCache; }
    public function markCacheAsValid() { $this->brokenCache = false; }
    ...
    public function bootDoctrine():bool
    {
         ...
         */
        try { $entityManagerConnection->connect(); }
    ...
    public function getAliasRepository($aliasRepository) { return self::$aliasRepositoryList[$aliasRepository] ?? $aliasRepository; }
