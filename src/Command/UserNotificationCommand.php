    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($actionShow) {
            ...
            foreach ($notifications as $key => $notification) {
                ...
                $message = "";
                $message .= "<info>Entry ID #" .($key+1) . "</info> / <red>User \"".$notification->getUser()."\"</red> / <ln>Notifications #" . $notification->getId()."</ln> : ". BaseService::shortenStr($notification->getContent(), 50);
