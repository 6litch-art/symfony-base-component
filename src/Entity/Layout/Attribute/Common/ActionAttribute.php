...
use Base\Repository\Layout\Attribute\Common\ActionRepository;
 ...
 *     @DiscriminatorEntry(value="attribute_action")
 */

abstract class ActionAttribute extends BaseAttribute
{
