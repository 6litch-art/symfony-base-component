...
class OrderedArrayCollection extends ArrayCollection
{
    ...
    public function key():int|string|null                    { $this->applyOrdering(); return parent::key(); }
    public function next():mixed                             { $this->applyOrdering(); return parent::next(); }
    public function current():mixed                          { $this->applyOrdering(); return parent::current(); }
    ...
    public function indexOf($element):int|string|bool        { $this->applyOrdering(); return parent::indexOf($element); }
    public function get($key):mixed                          { $this->applyOrdering(); return parent::get($key); }
    public function getKeys():array                          { $this->applyOrdering(); return parent::getKeys(); }
    public function getValues():array                        { $this->applyOrdering(); return parent::getValues(); }
    public function set($key, $value):void                   { $this->applyOrdering(); parent::set($key, $value); }
    public function count():int                              { $this->applyOrdering(); return parent::count(); }
    public function isEmpty():bool                           { $this->applyOrdering(); return parent::isEmpty(); }
    public function getIterator():\Traversable               { $this->applyOrdering(); return parent::getIterator(); }
    ...
    public function matching(Criteria $criteria): Collection { $this->applyOrdering(); return parent::matching($criteria); }
}