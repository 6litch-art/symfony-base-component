...
class SpreadsheetWarmer implements CacheWarmerInterface
{
    ...
    {
        if($this->shellVerbosity > 0 && php_sapi_name() == "cli") echo " // Warming up cache... PHP Spreadsheet".PHP_EOL.PHP_EOL;
