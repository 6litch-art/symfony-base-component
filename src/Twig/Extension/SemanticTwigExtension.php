...
{
    public function __construct(SemanticEnhancerInterface $semanticEnhancer) { $this->semanticEnhancer = $semanticEnhancer; }

    public function getName() { return 'semantic_extension'; }
