...
{
    public function taggedServiceIds(): string { return "workflow"; }

    public function classFqcn(): string { return Registry::class; }
    public function addMethod(): string { return "addWorkflow"; }
