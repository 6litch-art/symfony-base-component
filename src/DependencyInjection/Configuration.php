        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('access_restriction')->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('public_access')
                            ->info('Access to public visitors')
                            ->defaultValue("true")
                        ->end()
                    ->end()
                    ->children()
                        ->scalarNode('user_access')
                            ->info('Access to users')
                            ->defaultValue("true")
                        ->end()
                    ->end()
                    ->children()
                        ->scalarNode('admin_access')
                ...
                ->arrayNode('host_restriction')->addDefaultsIfNotSet()
                    ...
                    ->end()
                    ->children()
                        ->booleanNode('restrict_domain')
                            ->info('Apply restriction to domain')
                            ->defaultValue(false)
                        ->end()
                    ->end()
                    ->children()
