        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('access_restriction')->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('default_redirect_on_deny')
                ...
                ->arrayNode('router')->addDefaultsIfNotSet()
                    ...
                    ->children()
                        ...
                        ->arrayNode('reduction')->addDefaultsIfNotSet()
                            ->children()
                        ...
                        ->booleanNode('use_https')
                            ->info('Make sure url are redirected to https (useful for CLI)')
                        ->end()
                        ...
                        ->scalarNode('domain')
                            ->info('Define main domain here')
                        ->end()
                        ->scalarNode('subdomain')
                            ->info('Choose subdomain')
                        ->end()
