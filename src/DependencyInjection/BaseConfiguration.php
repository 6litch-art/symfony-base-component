                    ...
                    ->children()
                        ...
                        ->arrayNode('bootstrap_twitter')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('metadata')
                                    ->info('YAML metadata location: used in ')
                                    ->defaultValue("%kernel.project_dir%/public/bundles/base/vendor/bootstrap-icons/1.7.2/bootstrap-icons.yml")
                                    ->end()
                            ->end()
                            ->children()
                                ->scalarNode('css')
                                    ->info('')
                                    ->defaultValue("%kernel.project_dir%/public/bundles/base/vendor/bootstrap-icons/1.7.2/bootstrap-icons.css") 
                                    ->end()
                            ->end()
                        ->end()
