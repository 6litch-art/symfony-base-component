...
class BaseConfiguration extends AbstractBaseConfiguration
{
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        ->children()
            ...
            ->arrayNode('time_machine')->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('compression')
                        ...
                        ->defaultValue("gzip")
                        ->end()
                    ->scalarNode('time_limit')
                        ->info('Default time limit before deleting')
            ...
            ->arrayNode('obfuscator')->addDefaultsIfNotSet()
                ->children()
                    ...
                    ->scalarNode('cache_dir')
                        ->info('Identifier-map storage directory; must survive cache:clear/deploys or previously-issued short URLs become permanently unresolvable')
            ...
            ->arrayNode('attributes')->addDefaultsIfNotSet()
                ->children()
                    ->booleanNode('use_custom')
                        ->info('Use custom attribute reader')
                        ->defaultValue(null)
                        ->end()
                    ->arrayNode('paths')
                        ->addDefaultChildrenIfNoneSet()
                            ->prototype('scalar')
                                ->defaultValue('%kernel.project_dir%/src/Attribute')
                        ->end()
                    ->end()
                ->end()
            ->end()
