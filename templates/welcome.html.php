...
<head>
    ...
    <style>
        ...
        body { background: <?php echo $lightColor(); ?>; color: <?php echo $darkColor(); ?>; display: flex; font: 16px/1.5 sans-serif; justify-content: center; margin: 0; }
        h1, h2 { line-height: 1.2; margin: 0 0 .5em; }
        h1 { font-size: 36px; }
        h2 { font-size: 21px; margin-bottom: 1em; }
        a { color: <?php echo $darkColor(0.75); ?> }
        a:hover { text-decoration: none; }
        code { border-radius: 25px; background: <?php echo $lightColor(); ?>; box-shadow: 0 0 45px -15px hsl(<?php echo $hue; ?>, 20%, 2%); color: <?php echo $darkColor(); ?>; font-family: SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace; align-items: center; padding-right: 20px; position: relative; word-wrap: break-word; z-index: 1; }
        svg { overflow: hidden; vertical-align: text-bottom; }
        .wrapper { text-align: center; width: 100%; }
        .container {  position: relative;
            background: radial-gradient(ellipse at bottom, < ?=$ darkColor();
            color: <?php echo $lightColor(); ?>; }  .footer {position:relative;bottom:0;}  .footer #waves {position:relative;bottom:-10px;}
        ...
        .warning { background: <?php echo $lightColor(); ?>; display: flex; align-content: center; padding: 10px; text-align: left; justify-content: center; }
        ...
        .container .logo svg { fill: hsl(<?php echo $hue; ?>, 20%, 26%); }
        .welcome { padding-top: 4em; margin-bottom: 3em; }
        .welcome small { display: block; font-size: 85%; }
        .state { padding-bottom: 2em; }
        .state code, .state .state-ready { display: none; }
        .version { font-size: 34px; }
        .check { background: <?php echo $darkColor(); ?>; border-radius: 20px; width: 50px; display: flex; align-items: center; justify-content: center; height: 37px; margin: 6px 8px 6px 6px; }
        .check svg { fill: <?php echo $lightColor(); ?>; }
        .state-ready { margin: 28px 0 0; }
        .resources { margin: 0 auto; max-width: 1366px; padding: 1.5em 0 0 1em; }
        ...
        .resource svg { height: 48px; width: 48px; fill: <?php echo $darkColor(); ?>; margin-bottom: 5px; }
        ...
        @media (min-width: 768px) {
            ...
            .state { padding-bottom: 2.5em; }
            .state code { display: inline-flex; }
            .state .state-ready { display: block; }
    ...
    <div class="resources">
        <div class="row">
            <div class="resource">
                ...
                <h2>Documentation</h2>
                <a href="https://symfony.com/doc/<?php echo $docVersion; ?>/index.html">
