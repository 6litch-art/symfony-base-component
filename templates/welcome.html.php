...
<head>
    ...
    <style>
        ...
        .container {  position: relative; background: radial-gradient(ellipse at bottom, <?= $darkColor(); ?> 0%, hsl(<?= $hue; ?>, 20%, 13%) 100%); background-attachment: fixed; color: <?= $lightColor(); ?>; } .footer {position:relative;bottom:0;} .footer #waves {position:relative;bottom:-10px;}
...
<div class="wrapper">
    ...
    (function(){
        ...
        var canvas,context;
        var waves = [];
        var colours = ["hsla(<?= $hue; ?>, 20%, 95%, 0.3)","hsla(<?= $hue; ?>, 20%, 95%, 0.6)","hsla(<?= $hue; ?>, 20%, 95%, 1)"];
        var dt = 24;
